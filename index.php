...
<body>
      ...
      <div class="fb-home-timeline">
        ...
        <div class="create-post">
          <div class="create-post-header">
            ...
            // if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["form_submit"] == "post") {
            //   $post_aut_name = $_POST["aut_name"];
            //   $post_content = $_POST["post_content"];

            //   if(empty($post_aut_name) || empty($_FILES["aut_img"])){

            //     echo careat_alert("User not found");
            //   }else {
            ...
            //   array_push($posts,[
            //     "id"            => generateUniqueId("POSTS"),
            //     "user_name"     =>$post_aut_name,
            ...
            <button data-bs-toggle="modal" data-bs-target="#creat_post_modal">Whats on your mind ?</button>
          </div>
  ...
  <!--creat post  Modal -->
  <div class="modal fade" id="creat_post_modal">
        ...
        <div class="modal-body">
          <form id="post_form" enctype="multipart/form-data">
            <div class="my-2">
              ...
              <input type="text" name="aut_name" id="aut_name" placeholder="Author Name" class=" form-control">
            </div>
            <div class="my-2">
              <label for="name">Author Image</label>
              <input type="file" name="aut_img" id="aut_img" class="form-control">
            </div>
            <div class="my-2">
            ...
            <div class="my-2">
              ...
              <input type="file" multiple name="post_img[]" id="post_img" class="form-control" placeholder="Post Image">
            </div>
            <div class="my-2">
              <label for="name">Post Video</label>
              <input type="file" accept="video/*" name="post_video" id="post_video" class="form-control" placeholder="Post Image">
            </div>

            <div class="my-2">
              <input type="submit" class=" btn btn-primary w-100 " name="form_submit" value="post">
            </div>
          </form>
        </div>
      </div>
  ...
  <!--creat Comment  Modal -->
  <div class="modal fade" id="creat_comment_modal">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header d-flex justify-content-between">
          <h5 class="modal-title" id="exampleModalLabel">Creat Comment</h5>
          <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form  id="coment_form" enctype="multipart/form-data">
            <div class="my-2">
              <label for="name">Author Name</label>
              <input type="text" name="comment_aut_name" id="aut_name" placeholder="Author Name" class=" form-control">
            </div>
            <input type="hidden" name="comment_id" id="comment_id" placeholder="Author Name" class=" form-control">
            <div class="my-2">
              <label for="name">Author Image</label>
              <input type="file" name="comment_aut_img" id="aut_img" class="form-control">
            </div>
            <div class="my-2">
              <label for="name">Comment Content</label>
              <textarea name="comment_content" id="comment_content" class=" form-control"></textarea>
            </div>
            <div class="my-2">
              <label for="name">Comment image</label>
              <input type="file" multiple name="comment_img" id="comment_img" class="form-control" placeholder="Post Image">
            </div>

            <div class="my-2">
              <input type="submit" name="coment_form" class=" btn btn-primary w-100 " value="comment">
            </div>
          </form>
        </div>
      </div>
  ...
  <script>
    let li = document.querySelectorAll(".comment_click");
